...
const ContactsContainer = () => {
  ...
  return (
    <div className="relative md:w-[35vw] lg:w-[30vw] xl:w-[20vw] bg-[#1b1c24] border-r-2 border-[#2f303] w-full">
        <div className="pt-3">
            <Logo/>
        </div>
        <div className="my-5">
            <div className="flex items-center justify-center pr-26">
                <Title text="Tin nhắn riêng" />
                <NewDM />
            </div>
...
const Logo = () => {
    return (
      <div className="flex p-5  justify-start items-center gap-2">
        ...
        <span className="text-3xl font-semibold ">Xuân Hoàng</span>
      </div>
    );
  };
